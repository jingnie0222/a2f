...
def sendMail(title,body,tlist, name = "F2A Autotest", attachment = "" , use_nl2br = True):
    ...
    'fr_name' : name,
    'fr_addr' : "fanghuizhi@sogou-inc.com",
    'title' : title.encode("GBK"),
    'body' : send_body.encode("GBK"), #use nl2br to adjust html-mail content.
    'mode' : "html",
    'maillist' : tlist,
    'attname' : attname,
    'attbody' : attbody
